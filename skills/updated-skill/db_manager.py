...
# Sync to GitHub
from github_ops import GitHubSync
github_sync = GitHubSync()
success = github_sync.sync_database(self.db_path, JSON_EXPORT_PATH, self.device_id)

if success:
    print("Data synced to GitHub successfully")
else:
    print("GitHub sync failed - data exported locally only")
